                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/sidebar.Go Home')}} </a>
                                </li>

                                <li class="breadcrumb-item active">{{__('admin/sidebar.delivery media')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <form class="form" action="{{route('update.shippings.methods',$shippingMethod -> id)}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/sidebar.cost')}} </label>
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1"
                                                    ...
                                                    <i class="ft-x"></i> {{__('admin/sidebar.Go back')}}
                                                </button>
